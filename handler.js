                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? 'ʜᴀʏ ᴀᴅᴍɪɴ ʏᴀɴɢ ɢᴀɴᴛᴇɴɢ/ᴄᴀɴᴛɪᴋ,ᴀQ ᴍᴀᴜ ɪɴᴛʀᴏ ɴɪʜ' : 'sampai jumpa', action === 'add' ? '.intro' : 'FokusID')
                        }
                    }
                }
                break
